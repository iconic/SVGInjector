...
- [#11](https://null/flobacher/SVGInjector2/pull/11) TODO: don't add class dups (@stryju)
...
- [#2](https://null/flobacher/SVGInjector2/pull/2) Missing a closing `)` on example console.log (@FStop)
...
- [#5](https://null/flobacher/SVGInjector2/pull/5) Bower (@hoetmaaiers)
